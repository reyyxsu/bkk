...
<section id="about" class="about section">
  ...
  <div class="container section-title" data-aos="fade-up">
    ...
    <p>Bursa Kerja Khusus (BKK) adalah sebuah lembaga yang dibentuk di Sekolah Menengah Kejuruan Negeri dan Swasta,
      sebagai
      unit pelaksana yang memberikan pelayanan dan informasi lowongan kerja, pelaksana pemasaran, penyaluran dan
      penempatan
  ...
  <div class="container">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
        <h3>Tujuan</h3>
        <ul>
          <li><i class="bi bi-check-circle"></i> <span>Sebagai wadah dalam mempertemukan tamatan dengan pencari
              kerja.</span></li>
          <li><i class="bi bi-check-circle"></i> <span>Memberikan layanan kepada tamatan sesuai dengan tugas dan
              fungsi masing-masing seksi yang ada dalam BKK.</span></li>
          <li><i class="bi bi-check-circle"></i> <span>Sebagai wadah dalam pelatihan tamatan yang sesuai dengan
              permintaan pencari kerja.</span></li>
          <li><i class="bi bi-check-circle"></i> <span>Sebagai wadah untuk menanamkan jiwa wirausaha bagi tamatan
              melalui pelatihan.</span></li>
          <!-- ===  
        </ul>
...
<section id="services" class="services section light-background">
  ...
  <div class="container section-title" data-aos="fade-up">
    <h2>Perusahaan</h2>
    <p>List Perusahaan yang bekerja sama dengan pihak BKK SMKN 5 Kota Bekasi :</p>
  </div><!-- End Section Title -->
  ...
  <div class="container">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
        ...
        <div>
          <h4 class="title"><a href="service-details.html" class="stretched-link">PT. Tirta Alam Segar</a></h4>
          <p class="description">PT Tirta Alam Segar adalah Sebuah perusahan yang tergabung dalam Wings Group perusahaan terbesar di indonesia yang bergerak dalam bidang Produksi makanan serta minuman</p>
        </div>
      </div>
      <!-- End Service Item -->
